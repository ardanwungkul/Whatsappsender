    ...
    <v-dialog v-model="dialogActive">
        <template v-slot:activator="{ props: activatorProps }">
            <button v-bind="activatorProps" type="button">
                <div
                    :class="buttonClass"
                    class="flex gap-2 items-center text-white bg-red-500 hover:bg-opacity-90 rounded-lg px-3 py-1 text-sm"
                >
        ...
        <template v-slot:default="{ isActive }">
            ...
            >
                <button
                    ...
                    class="fa-solid fa-x rounded-xl hover:bg-gray-100 px-3 py-2 absolute right-3 top-3 text-gray-500"
                ></button>
